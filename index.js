...
const unfundedString = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. 
Currently, ${numUnfunded === 1 ? '1 game remains' : `${numUnfunded} games remain`} unfunded. We need your help to fund these amazing games!`;
